const caruselContainer = document.querySelectorAll(".finder_carusel");

caruselContainer.forEach((element, index) => {
  $(document).ready(function () {
    let idx = 0;
    const cards = element.querySelectorAll(".img_carusel");
    const endPoint = element.querySelector("#allOfferNum1");
    let value = parseInt(document.querySelector("#offerNum1").innerHTML);


    endPoint.innerHTML = cards.length;
    ...
    $(element)
      ...
      .click(function () {
        ...
        value++;
        $(element).find("#offerNum1").text(value)
      });
    ...
    function changeImage() {
      ...
      $(element).find("#images_carusel").css('transform', `translateX(${-idx * 360}px)`)
    }
