...
<div class="about">
  <div class="container">
    <div class="about-wrapper">
      ...
      <h3><b>Добро пожаловать в магазины Canon Store</b></h3>
      <div class="b-content_narrow" style="text-align: justify;">
        <p><b>Canon Store</b>  — это единственный фирменный магазин техники Canon в России.</p>
        ...
        <ul class="faq_content_list">
          <li>самый полный и актуальный ассортимент фототехники Canon, а также оптических устройств Canon Sport Optics</li>
          <li>широкий спектр аксессуаров и сувенирной продукции</li>
          <li>профессиональную консультацию от представителей компании</li>
          <li>возможность непосредственно на месте познакомится и оценить качество продукции Canon</li>
          <li>оптимальные цены рекомендованные производителем</li>
          <li>акции и специальные предложения от компании Canon</li>
        ...
        <p>А тем, кто ценит удобства дистанционного способа покупки, мы предлагаем воспользоваться услугами фирменного <nobr>Интернет-магазин</nobr> техники Canon <a href="/">www.Canonstore.ru</a></p>
        <p>Наш сайт дает полную, достоверную и объективную информацию о продуктах компании Canon, специалисты <nobr>Интернет-магазина</nobr> готовы оказать профессиональную помощь в выборе модели, посоветовать аксессуар или сумку, предложить различные варианты оплаты и доставки приобретаемого товара по Москве или в регионы.</p>
        ...
        <p>
          Деятельность <nobr>Интернет-магазина</nobr> Canon Store, расположенного по адресу <a href="/">www.Canonstore.ru</a> и фирменного магазина Canon Store осуществляется в соответствии с действующим российским законодательством и, в частности, в соответствии с «Законом о защите прав потребителей» № 2300–1 от 07/02.1992.
        </p>
      </div>
    </div>
  </div>
