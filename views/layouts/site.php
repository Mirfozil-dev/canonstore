                ...
                <h5 style="font-size: 16px; font-weight: 400; color: #fff;">КАТАЛОГ
                    ...
                    <div class="drop_down_catalog_items">
                        <div class="drop_down_catalog_item">
                            <img src="<?= Yii::getAlias('@web'); ?>/images/drop_down_items/percentage.png" alt=""
                                 width="16px"><a class="href_catalog" href="/site/catalog">АКЦИЯ</a>
                        </div>
                        <div class="drop_down_catalog_item" id="camera_navbar">
                            <img src="<?= Yii::getAlias('@web'); ?>/images/drop_down_items/black-camera.png" alt=""
                                 width="16px"><a class="href_catalog" href="/site/catalog">ФОТОКАМЕРЫ</a>
                            <img
                                    class="angle-right"
                            ...
                            <div class="drop_camera_scroll row">
                                <div class="drop_camera_item_scroll col-md-5">
                                    <h6 class="camera_header_scroll"><a class="href_catalog1" href="/site/catalog">ЗЕРКАЛЬНЫЕ
                                            ФОТОКАМЕРЫ</a></h6>
                                ...
                                <div class="drop_camera_item_scroll col-md-7">
                                    <h6 class="camera_header_scroll"><a class="href_catalog1" href="/site/catalog">БЕЗЗЕРКАЛЬНЫЕ
                                            ФОТОКАМЕРЫ NIKON Z</a></h6>
                                    <p><a class="href_catalog1" href="/site/catalog">Для любителей</a></p>
                                    <p><a class="href_catalog1" href="/site/catalog">Для профессионалов</a></p>
                                </div>

                                <div class="drop_camera_item_scroll col-md-6">
                                    <h6 class="camera_header_scroll"><a class="href_catalog1" href="/site/catalog">КОМПАКТНЫЕ
                                            ФОТОКАМЕРЫ</a></h6>
                        ...
                        <div class="drop_down_catalog_item" id="obective_navbar">
                            <img src="<?= Yii::getAlias('@web'); ?>/images/drop_down_items/obektive.png" alt=""
                                 width="17px"><a class="href_catalog" href="/site/catalog">ОБЪЕКТИВЫ</a>
                            <img
                                    class="angle-right"
                                    src="<?= Yii::getAlias('@web'); ?>/images/line-angle-right.png"
                                    alt=""
                            ...
                            <div class="drop_obektive_scroll row">
                                <div class="drop_camera_item_scroll col-md-6">
                                    <h6 class="camera_header_scroll"><a class="href_catalog1" href="/site/catalog">ОБЪЕКТИВЫ
                                            ДЛЯ DX</a></h6>
                        ...
                        <div class="drop_down_catalog_item" id="accessory_navbar">
                            <img src="<?= Yii::getAlias('@web'); ?>/images/drop_down_items/briefcase.png" alt=""
                                 width="17px"><a class="href_catalog" href="/site/catalog">АКСЕССУАРЫ</a><img
                                    class="angle-right"
                                    src="<?= Yii::getAlias('@web'); ?>/images/line-angle-right.png"
                                    alt=""
                                    width="6px"
                            ...
                            <div class="drop_accessory_scroll row">
                                <div class="drop_camera_item_scroll col-md-6">
                                    <h6 class="camera_header_scroll"><a class="href_catalog1" href="/site/catalog">ДЛЯ
                                            ФОТОКАМЕРЫ</a></h6>
                                    ...
                                    <p><a class="href_catalog1" href="/site/catalog">Сумки, рюкзаки, чехлы, ремни</a>
                                    </p>
                        ...
                        <div class="drop_down_catalog_item">
                            <img src="<?= Yii::getAlias('@web'); ?>/images/drop_down_items/spark.png" alt=""
                                 width="17px"><a
                                    class="href_catalog" href="/site/catalog">ВСПЫШКИ</a>
                        </div>
                        <div class="drop_down_catalog_item">
                            <img
                                    ...
                                    alt=""
                                    width="23px"
                                    style="margin-right: 14px;"><a class="href_catalog" href="/site/catalog">СУВЕНИРНАЯ
                                ПРОДУКЦИЯ</a>
                        </div>
                        <div class="drop_down_catalog_item" id="sport_navbar">
                            <img
                                    ...
                                    alt=""
                                    width="23px"
                                    style="margin-right: 14px;"><a class="href_catalog" href="/site/catalog">СПОРТИВНАЯ
                                ОПТИКА</a><img
                                    class="angle-right"
                                    src="<?= Yii::getAlias('@web'); ?>/images/line-angle-right.png"
                                    alt=""
                            ...
                            <div class="drop_sport_scroll row">
                                ...
                                <div class="drop_camera_item_scroll col-md-6">
                                    <h6 class="camera_heade_scrollr"><a class="href_catalog1" href="/site/catalog">БЕЗЗЕРКАЛЬНЫЕ
                                            ФОТОКАМЕРЫ NIKON Z</a></h6>
                                    <p><a class="href_catalog1" href="/site/catalog">Для любителей</a></p>
                                    <p><a class="href_catalog1" href="/site/catalog">Для профессионалов</a></p>
                                </div>
        ...
        <div class="container-xl">
            ...
            <div class="row click_cotalog_row">
                ...
                <div class="col-md-12 click_cotalog_item"><img
                            ...
                            alt=""
                            width="16px"
                            style="margin-right: 14px;"><a class="href_catalog" href="/site/catalog">ФОТОКАМЕРЫ</a>
                </div>
                <div class="col-md-12 click_cotalog_item">
                    <img
                ...
                <div class="col-md-12 click_cotalog_item">
                    <img
                            ...
                            alt=""
                            width="17px"
                            style="margin-right: 14px;"><a class="href_catalog" href="/site/catalog">АКСЕССУАРЫ</a>
                </div>
                <div class="col-md-12 click_cotalog_item">
                    <img
                            src="<?= Yii::getAlias('@web'); ?>/images/drop_down_items/shirt.png"
                            alt=""
                            width="23px"
                            style="margin-right: 10px;"><a class="href_catalog" href="/site/catalog">СУВЕНИРНАЯ
                        ПРОДУКЦИЯ</a></div>
                <div class="col-md-12 click_cotalog_item">
                    <img
                            src="<?= Yii::getAlias('@web'); ?>/images/drop_down_items/jump.png"
            ...
            <div class="row click_info_row">
                <div class="col-md-12 click_cotalog_item"><a class="href_catalog1" href="/site/about">О магазине</a>
                </div>
                <div class="col-md-12 click_cotalog_item"><a class="href_catalog1" href="/site/news">Новости</a></div>
                <div class="col-md-12 click_cotalog_item"><a class="href_catalog1" href="/site/delivery">Доставка и
                        оплата</a></div>
                <div class="col-md-12 click_cotalog_item"><a class="href_catalog1" href="/site/warranty">Гарантия и
                        сервис</a></div>
                <div class="col-md-12 click_cotalog_item"><a class="href_catalog1" href="/site/contact">Контакты</a>
                </div>
            ...
            <div class="bottom_menu" id="bottom_menu">
                    ...
                    <div class="dropDownItems" id="dropDownItems">
                        ...
                        <div class="dropDownItem2">
                            ...
                            <div class="drop_camera row">
                                <div class="drop_camera_item col-md-6">
                                    <h6 class="camera_header"><a class="href_catalog1" href="/site/catalog">ЗЕРКАЛЬНЫЕ
                                            ФОТОКАМЕРЫ</a></h6>
                                    <p><a class="href_catalog1" href="/site/catalog">Для начинающих</a></p>
                                    <p><a class="href_catalog1" href="/site/catalog">Для любителей</a></p>
                                    <p><a class="href_catalog1" href="/site/catalog">Для профессионалов</a></p>
                                ...
                                <div class="drop_camera_item col-md-6">
                                    <h6 class="camera_header"><a class="href_catalog1" href="/site/catalog">БЕЗЗЕРКАЛЬНЫЕ
                                            ФОТОКАМЕРЫ NIKON Z</a></h6>
                                    <p><a class="href_catalog1" href="/site/catalog">Для любителей</a></p>
                                    <p><a class="href_catalog1" href="/site/catalog">Для профессионалов</a></p>
                                </div>
                                ...
                                <div class="drop_camera_item col-md-6">
                                    <h6 class="camera_header"><a class="href_catalog1" href="/site/catalog">КОМПАКТНЫЕ
                                            ФОТОКАМЕРЫ</a></h6>
                                    <p><a class="href_catalog1" href="/site/catalog">Компактные</a></p>
                                    <p><a class="href_catalog1" href="/site/catalog">Супер-Зум</a></p>
                                    <p><a class="href_catalog1" href="/site/catalog">Водозащищенные</a></p>
                        ...
                        <div class="dropDownItem3">
                            ...
                            <div class="drop_obektive row">
                                <div class="drop_camera_item col-md-6">
                                    <h6 class="camera_header"><a class="href_catalog1" href="/site/catalog">ОБЪЕКТИВЫ
                                            ДЛЯ
                                            DX</a></h6>
                                    <p><a class="href_catalog1" href="/site/catalog">Универсальные</p>
                                    <p><a class="href_catalog1" href="/site/catalog">Широкоугольные</p>
                        ...
                        <div class="dropDownItem4">
                            ...
                            <div class="drop_accessory row">
                                <div class="drop_camera_item col-md-6">
                                    <h6 class="camera_header"><a class="href_catalog1" href="/site/catalog">ДЛЯ
                                            ФОТОКАМЕР</a></h6>
                                    <p><a class="href_catalog1" href="/site/catalog">Карты памяти</a></p>
                                    <p><a class="href_catalog1" href="/site/catalog">Питание фотокамер</a></p>
                                    <p><a class="href_catalog1" href="/site/catalog">Штативы, моноподы</a></p>
                ...
                <div class="info_middle" id="info_middle">
                    ...
                    <div class="info_right">
                        <img src="<?= Yii::getAlias('@web'); ?>/images/like.png" alt="" width="24px"><a
                                class="href_catalog"
                                href="/site/cart"></a>Оставить
                        отзыв
                    </div>
                </div>
                <div class="info" id="info">
                    ...
                    <div class="info-drop-down">
                        ...
                        <div class="info-drop-down-item"><a class="href_catalog" href="/site/delivery">Доставка и
                                оплата</a>
                        </div>
                        <div class="info-drop-down-item"><a class="href_catalog" href="/site/warranty">Гарантия и
                                сервис</a>
                        </div>
            ...
            <div class="popup-content">
                ...
                <div class="row">
                    <div class="col-md-6 contact-left" style="border-right: solid 1px #ccc;">
                        ...
                        <div class="logout">
                            <span class="forget-password" id="forget-password">Восстановить пароль</span><span
                                    class="sign-up" id="sign-up">Зарегистрироваться</span>
                        </div>

                    </div>
                    <div class="col-md-6 contact-right">
                        <div class="contact-right-header">Единая авторизация Nikon</div>
                        <div class="contact-right-title">Для вашего удобства мы разработали систему единой авторизации
                            на
                            сайтах:
                        </div>
                        <div class="img_contact" style="margin: 10px;"><img
                                    src="<?= Yii::getAlias('@web'); ?>/images/pop up/popup.png" alt="" width="100%">
                        </div>
                        <div class="contact-left-footer">Теперь вход в личный кабинет возможен под одним и тем же
                            паролем.
                        </div>
                    </div>
                </div>
        ...
        <div class="popup2">
            ...
            <div class="popup-content2">
                <img
                        ...
                        width="30px">
                <div class="row">
                    <div class="col-md-6 contact-left sing_up_div">
                        <div class="contact-left-header">Войти на сайт</div>
                        <input type="text" name="" id="" placeholder="Имя*" class="contact-input sign_up_name">
                        <small class="error_name hidden text-danger" style="font-size: 12px; margin-bottom: 0!important;">Поле не может быть пустым!</small>
                        <input type="text" name="" id="" placeholder="Фамилия*" class="contact-input sign_up_surname">
                        <small class="error_surname hidden text-danger" style="font-size: 12px; margin-bottom: 0!important;">Поле не может быть пустым!</small>
                        <input type="email" name="" id="" placeholder="E-mail*" class="contact-input sign_up_email">
                        <small class="error_email hidden text-danger" style="font-size: 12px; margin-bottom: 0!important;">Поле не может быть пустым!</small>
                    </div>
                    <div class="col-md-6 contact-right">
                        <div class="contact-right-header">Единая авторизация Nikon</div>
                        <div class="choose-flag">
                            <select name="" id="country_code" class="choose-flag-items">
                                <option value="RU">
                                    <!--<img src="<?= Yii::getAlias('@web'); ?>/images/contact/ru.png" alt="" width="1000px">-->
                                    RU
                                </option>
                                <option value="UZ">
                                    <!--<img src="<?= Yii::getAlias('@web'); ?>/images/contact/uz.jpg" alt="" width="20px">-->
                                    UZ
                                </option>
                                <option value="KZ">
                                    <!--<img src="<?= Yii::getAlias('@web'); ?>/images/contact/kz.jpg" alt="" width="20px">-->
                                    KZ
                                </option>
                            </select>
                            <input type="text" name="" id="" placeholder="Телефон*"
                                   class="contact-input sign_up_number">
                        </div>
                        <input type="password" name="" id="" placeholder="Пароль*" class="contact-input sign_up_pass">
                ...
                <div class="sign_up_box">
                    ...
                    <span class="checkeds">
                            Я принимаю условия Политики о конфиденциальности.</span>
                    <button class="popup-submit sign_up_user">Войти</button>
                    <br>
                    <div class="logout">
                        <span class="forget-password" id="forget-password2">Восстановить пароль</span><span
                                class="sign-up"
                                id="contact5">Войти</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="search-wrapper">
        <div class="search-container">
            ...
            <div class="search-div">
                <input type="text" placeholder="Поиск" class="search-input" id="search-input" onkeyup="searchItem()"
                       title="name">
        ...
        <div class="footer-container1">
            <div class="footer_top">
                <div class="footer-subscribe-section col-7">
                    <div class="footer-subscribe-title footer-top-title footer-first-column col-4">Подпишитесь: новинки,
                        скидки, полезные статьи
                    </div>
                    <div class="footer-subscribe-form col-8" id="footer-sender-subscribe">
                        ...
                        <div class="footer-subscribe-form-check">
                            ...
                            <label for="footer-checkbox" class="footer-check-label">Я принимаю условия Политики о
            ...
            <div class="footer_main">
                ...
                <div class="footer-main-2 col-xl-auto">
                    ...
                    <div class="footer-mob-flex">
                        <div class="social-list">
                            <a class="social-link" href="" target="_blank" rel="nofollow"><i
                ...
                <div class="footer-main-3 col-xl-auto">
                    ...
                    <a class="footer-projects-link" href="" target="_blank"><img src="images/my-nikon.png" alt
                                                                                 width="175"></a>
                    <a class="footer-projects-link img-nps" href="" target="_blank"><img src="images/nps.png" alt
                                                                                         width="160"></a>

                    <div class="canon-school-section">
                        <a class="canon-school-logo" href="" target="_blank"><img src="images/nikon-school.png" alt
                                                                                  width="100"></a>
                ...
                <div class="ns-footer_bottom-holder">
                    ...
                    <div class="ns-footer_bottom-right">
                        <div class="footer-info-text">
                            Все цены указаны в рублях и включают в себя все налоги и сборы. Кол-во товара ограничено.
                            Предложения действительны, при наличии товара на складе
                        </div>
    ...
    <div>
        <div class="openDraw" id="showUp" style="display: none;">
            <section class="showItem1"
                ...
                <svg class="b24-crm-button-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                     viewBox="0 0 24 28">
        ...
        <button type="menu" class="gButton" id="btn" onclick="openBox()">
            <svg class="b24-crm-button-icon b24-crm-button-icon-active" xmlns="http://www.w3.org/2000/svg" width="28"
                 height="28"
                 viewBox="0 0 28 29">
        ...
        <div id="myModal" class="modal">
            <div class="modal-content">
                ...
                <div class="b24-form-header b24-form-padding-side">
                    ...
                    <div class="header-description">Поделитесь мнением о нашей работе или задайте нам любой интересующий
                        вас
                ...
                <div class="inputBlock">
                    ...
                    <textarea name="" class="modal-popup-textarea inputBtn1" placeholder="Чем мы можем помочь?"
                              cols="50"
                              rows="50"></textarea>
                    <section class="checkboxPopup" id="popUpShow" onclick="secondOpenBox()">
                        <input type="checkbox" id="showRatings" name="showRatings" class="checkboxItemModal" checked
                               required>
    ...
    <div id="mySecondModal" class="secondModal">
        ...
        <div class="secondModal-content">
            ...
            <div style="overflow: scroll;">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo placeat natus eius sed atque earum
                unde
                quisquam quia? Dicta ullam nam consequuntur incidunt in, aperiam ipsum laborum nobis. Est alias magni
                eum a
                distinctio dolorem quod modi necessitatibus vitae fugiat, nobis, nemo et neque praesentium, sunt veniam
                dolore rem? Veniam sed pariatur porro reprehenderit animi fugit, modi a laboriosam alias nesciunt ipsum,
                fuga provident iusto nobis tenetur earum aliquam? Soluta autem excepturi possimus maiores nisi nemo
                fugit
                beatae molestias, temporibus deserunt, voluptatum libero illo dolores earum iure vel reprehenderit ipsum
                quasi quo placeat ex vero eveniet! Nulla harum dolorum ducimus? Earum omnis esse dolorum suscipit natus.
                Perferendis doloremque placeat eaque cupiditate nobis atque nostrum, vitae laborum voluptate. Laboriosam
                maxime fuga aspernatur nam neque perferendis, autem vel quisquam eius. Sunt quia error minima
                repellendus,
                eveniet iste doloribus, tempora praesentium dolores, excepturi ea labore quos? Ipsam dolores quis beatae
                fugit. Harum, itaque.
